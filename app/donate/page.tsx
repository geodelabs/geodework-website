  ...
  return (
    <div className="mx-auto max-w-3xl px-2 sm:py-16">
      ...
      <div className="mb-7 flex flex-col items-center gap-4 text-center">
        <p className="text-lg">
          Your support helps us continue building and improving our product and
          ecodev work.
        </p>
      </div>
            ...
            <div className="mt-12 space-y-4">
              ...
              <div className="flex flex-col gap-6">
                ...
                {alternativeOptions.map((option) => (
                  <div className="rounded-2xl bg-white/5 p-6" key={option.name}>
          ...
          <div className="mt-16 space-y-4">
            ...
            <div className="rounded-2xl bg-white/5 p-5">
              <ol className="mx-auto max-w-md list-inside list-decimal space-y-3 text-left">
                ...
                <li>
                  For other methods: Click the link and follow the instructions
                  on the website
                </li>
              </ol>
            </div>
